...
class MarkdownReporter extends _base.BaseReporter {
  ...
  async onEnd(result) {
    ...
    if (summary.unexpected.length || summary.flaky.length) {
      ...
      if (summary.flaky.length) this._printTestListDetails(':warning:', summary.flaky, lines);
      lines.push(`</details>`);
    }
  ...
  _printTestDetails(prefix, test, lines) {
    ...
    for (const result of test.results) {
      ...
      retry++;
      if ((_result$error = result.error) !== null && _result$error !== void 0 && _result$error.snippet) {
        lines.push(``);
        lines.push('```');
